...
const { AUTH_FACEBOOK_CLIENT_ID: clientID, AUTH_FACEBOOK_CLIENT_SECRET: clientSecret, AUTH_FACEBOOK_CALLBACK_URL: callbackURL, } = process.env;
exports.default = (api) => __awaiter(void 0, void 0, void 0, function* () {
    api.passport.use(new passport_facebook_1.default({
