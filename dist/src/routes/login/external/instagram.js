...
const passport_instagram_1 = __importDefault(require("passport-instagram"));
const controller_1 = __importDefault(require("../controller"));
const service = 'instagram';
const { AUTH_INSTAGRAM_CLIENT_ID: clientID, AUTH_INSTAGRAM_CLIENT_SECRET: clientSecret, AUTH_INSTAGRAM_CALLBACK_URL: callbackURL, } = process.env;
exports.default = (api) => __awaiter(void 0, void 0, void 0, function* () {
    api.passport.use(new passport_instagram_1.default({
