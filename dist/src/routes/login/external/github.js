...
const { AUTH_GITHUB_CLIENT_ID: clientID, AUTH_GITHUB_CLIENT_SECRET: clientSecret, AUTH_GITHUB_CALLBACK_URL: callbackURL, } = process.env;
exports.default = (api) => __awaiter(void 0, void 0, void 0, function* () {
    api.passport.use(new passport_github2_1.default({
